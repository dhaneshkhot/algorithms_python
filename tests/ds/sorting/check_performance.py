...
# These imports are necessary even though it may sees as not being used
...
if __name__ == "__main__":
    ...
    """
    Python's default 'sorted' algorithm uses Tim Sort (combination of Insertion sort and Merge sort).
    Avg/Worst: O(n log2n); Best: O(n) when already sorted
    """
    run_sorting_algorithm(algorithm="sorted", array_to_sort=arr)
